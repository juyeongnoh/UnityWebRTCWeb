...
startBtn1.addEventListener('click', function () { setUp(connId1.options[connId1.selectedIndex].value, 0) });
startBtn2.addEventListener('click', function () { setUp(connId2.options[connId2.selectedIndex].value, 1) });
startBtn3.addEventListener('click', function () { setUp(connId3.options[connId3.selectedIndex].value, 2) });
startBtn4.addEventListener('click', function () { setUp(connId4.options[connId4.selectedIndex].value, 3) });
startBtn5.addEventListener('click', function () { setUp(connId5.options[connId5.selectedIndex].value, 4) });
...
function setCodecPreferences(index) {
  ...
  const transceivers = renderstreaming[index].getTransceivers().filter(t => t.receiver.track.kind == "video");
